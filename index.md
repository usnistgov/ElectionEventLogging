...
Jim Cantor
Hart Intercivic | McDermott Coots
UniSyn | Herb Deutsch
Election Systems and Software
Arthur Keller
University of California | James Long
Smartmatic | Neal McBurnett
ElectionAudits
John McCarthy
Verified Voting | Ian Piper
Dominion Voting Systems | Richard Rivello
National Institute of Standards and Technology
Paul Stenbjorn
...
* Element and attribute names observe variations of "CamelCase" conventions2, that is:
o Element and enumeration and primitive names begin with a capital letter and names that consist of multiple words are concatenated and each word begins with a capital letter, thus "CamelCase".  For example, `<ElectionEventLog>`.
...
o Element (or attribute) names such as `<Type>` are followed by `<OtherType>`.
...
Table 3.2 - Elements for `<ElectionEventLog>`
...
Table 3.3 - Attributes for `<Device>`
Attribute | Required | Type | Attribute Description
...
3.2.3 The <ElectionEvent> Element
...
Table 3.5 - Attributes for `<ElectionEvent>`
Attribute | Required | Type | Attribute Description
...
Table 3.6 - Elements for `<ElectionEvent>`
Element | Multiplicity | Type | Element Description
...
3.3 Elements and Complex Types - Election Event Logging Documentation Schema
...
3.3.1 The <ElectionEventIdDescription> Complex Type
For associating a brief description with an election event log ID.
Table 3.7 - Attributes for `<ElectionEventIdDescription>`
Attribute | Required | Type | Attribute Description
`<id>` | yes | `xsd:string` | An identifier associated with the event.
Table 3.8 - Elements for `<ElectionEventIdDescription>`
Element | Multiplicity | Type | Element Description
...
3.3.2 The <ElectionEventLogDocumentation>` Complex Type
...
Table 3.9 - Attributes for `<ElectionEventLogDocumentation>`
Attribute | Required | Type | Attribute Description
...
Table 3.10 - Elements for `<ElectionEventLogDocumentation>`
Element | Multiplicity | Type | Element Description
...
3.3.3 The <ElectionEventTypeDescription> Complex Type
For associating a brief description with an election event log type.
Table 3.11 - Attributes for `<ElectionEventTypeDescription>`
Attribute | Required | Type | Attribute Description
`<type>` | yes | `xsd:string` | An identifier associated with the event type.
Table 3.12 - Elements for `<ElectionEventIdDescription>`
Element | Multiplicity | Type | Element Description
...
Table 3.13 - Values for `<DeviceUsage>
...
3.4.2 The DispositionType Enumeration
Enumeration for types of dispositions in the `<disposition>` attribute.
Table 3.14 - Values for `<DispositionType>`
Value | Value Description
...
Vote-capture device:  Device that is used directly by a voter to cast a ballot. See also: direct record electronic (DRE).
...
[2] Election Assistance Commission, Voluntary Voting System Guidelines Version 1.1 Volume 1, https://eac926.ae-admin.com/assets/1/Documents/VVSG.1.1.VOL.1.FINAL.pdf [accessed 3/31/2016].
[3] Object Management Group (OMG), UML Specification version 1.1 (OMG document ad/97-08-11) September 22, 2011, http://omg.org/ [accessed 2/1/2016].
[4] W3C, XML Signature Syntax and Processing (Second Edition), W3C Recommendation, June 10, 2008, http://www.w3.org/TR/xmldsig-core/ [accessed 2/1/2016].



Appendix D- File Download Locations
The files associated with this specification are available for download from a NIST repository.  These files are:
* This specification,
* XML schema,
* Example XML files,
...
1 Clauses v and vi deal with access control to the time adjustment mechanism and capabilities to limit clock drift and are not addressed in this specification.
2 See https://en.wikipedia.org/wiki/CamelCase.
---------------
...
Draft SP 1500-101                                                              NIST Election Event Logging CDF Specification
